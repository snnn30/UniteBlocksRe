...
public partial class ObservableTrackerTab : VBoxContainer
{
    ...
    public override void _Ready()
    {
        ...
        enableAutoReloadToggle.ButtonPressed = enableAutoReload = GetSettingOrDefault(
                settings,
                EnableAutoReloadKey,
                false
            )
        ...
        enableTrackingToggle.ButtonPressed = enableTracking = GetSettingOrDefault(
                settings,
                EnableTrackingKey,
                false
            )
        ...
        enableStackTraceToggle.ButtonPressed = enableStackTrace = GetSettingOrDefault(
                settings,
                EnableStackTraceKey,
                false
            )
        ...
        var reloadButton = new Button { Text = "Reload", TooltipText = "Reload View." };
        var GCButton = new Button { Text = "GC.Collect", TooltipText = "Invoke GC.Collect." };
